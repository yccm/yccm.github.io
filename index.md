...
<div class="info-block">
  <ul>
    ...
    <li><strong>LLM Alignment and Agentic AI:</strong> This research studies alignment methods and agentic AI for large language models, with a focus on efficient data synthesis, personalization, and the application of agentic workflows to improve performance in decision-making tasks.
  </ul>
</div>
